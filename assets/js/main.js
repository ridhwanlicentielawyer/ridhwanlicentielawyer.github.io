...
(function ($) {
  ...
  function getGreeting() {
    ...
    if (jam >= 5 && jam < 12)
      return "Selamat pagi, Saya dapat informasi ini dari www.licentielawyer.com";
    if (jam >= 12 && jam < 15)
      return "Selamat siang, Saya dapat informasi ini dari www.licentielawyer.com";
    if (jam >= 15 && jam < 18)
      return "Selamat sore, Saya dapat informasi ini dari www.licentielawyer.com";
    return "Selamat malam, Saya dapat informasi ini dari www.licentielawyer.com";
  }

  /* Fungsi untuk membuat link WhatsApp */
  function generateWhatsAppLink(waNumber) {
  ...
  /* Fungsi untuk memperbarui href elemen */
  function updateWhatsAppLink(selector, waNumber) {
    $(selector).attr("href", generateWhatsAppLink(waNumber));
  }
  ...
  $(document).ready(function () {
    ...
    var nomorWA = "6287886660696"; // Ganti dengan nomor yang sesuai
    updateWhatsAppLink("#whatsapp-link", nomorWA);
  });
})(jQuery);
